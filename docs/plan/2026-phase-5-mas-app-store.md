...
| 2026-05-02 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 inventory (**MAS-1a**..**#242**) + §3.9 **`cfg` / `mas`** table + `rg` sweep commands; review lenses still **TBD**. MR review: **#243** doc polish (PR metadata, **MAS-2a** row, smoke §1, `mas-sandbox-launch-smoke.sh` link, `rg` note). |
