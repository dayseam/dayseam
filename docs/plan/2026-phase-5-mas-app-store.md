...
| 2026-05-02 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) — §2 inventory (**MAS-1a**..**#242**) + §3.9 **`cfg` / `mas`** table + `rg` sweeps; MR review **#243** polish; then §2 refreshed through **#243** (`f9b9d68`) and **§3.1 IPC** desk review (**Partial**: `distribution_profile`, `COMMANDS` allow-list, bookmark paths in [`ipc/commands.rs`](../../apps/desktop/src-tauri/src/ipc/commands.rs)). **§3.2**–**§3.8** still **TBD**. MR **#244** review: **#244** vs tip note, **MAS-3b**, `sinks_add`, single-bundle wording. |
| 2026-05-02 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`7b88204`** (**#244**); **§3.4 Filesystem** **Partial** (`security_scoped`, DB migration/repo, `ipc/commands`, `local_git_scan`, **MAS-0b** §9.4 anchor + **MAS-9c** follow-up). MR **#245** + MR review: Canonical smoke **§1** item 3, line-by-line audit wording. |
| 2026-05-03 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`fe1d079`** (**#245**); **§3.2 Errors** **Partial** (`DayseamError` + `IPC_SECURITY_SCOPED_BOOKMARK_*`, `map_bookmark_materialize_db_error`, sync `internal` vs materialize `InvalidConfig` split; hooks **§3.3** / **§3.5** / **§3.7**). MR **#246**. |
| 2026-05-04 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`f9fa74a`** (**#246**); **§3.3 Keychain** **Partial** (**MAS-5b2** `keychain_profile`, **MAS-0b** §12 matrix, `dayseam-secrets` KeychainStore + `split_key`, IPC/orphan audit / entitlements; **MAS-9c** hardware cold-start). MR **#247** + MR review: **§2.1** head-row **#247** note, **§3.9** `ipc/commands` + **§3.3** evidence wording. |
| 2026-05-05 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`c68282b`** (**#247**); **§3.5 OAuth** **Partial** (`ipc/oauth`, `oauth_config` / `oauth_session`, **MAS-6b** `network.server` + **MAS-0b** §13–§14, `OAUTH_LOGIN_*`; **§3.9** `ipc/oauth` row; **MAS-9c** smoke item **6**). MR **#248** + MR review: **`oauth.login.*`** vs **`DayseamError`** mapping, **§3.2** gap + **§2.3** centres. |
| 2026-05-06 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`9b130eb`** (**#248**); **§3.6 Subprocesses** **Partial** (**MAS-0b** §8: `shell_open` / `opener`, **§3.5** OAuth browser + loopback, **`connector-local-git`** **`git2`** vendored libgit2; no shipped helper **`.app`**). MR **#249** + MR review: **MAS-0b** §8 row numbers vs review §3.5 cross-refs; §3.9 **`ipc/oauth`** + §8 row **5** tests-only. |
| 2026-05-07 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`abcf4aa`** (**#249**); **§3.7 Capability deny-list** **Partial** (**MAS-0b** §6: **`tauri.mas.conf.json`** **`capabilities`: [`default`]**, **`updater.json`** not merged, **`main.rs`** **MAS-3a** skips updater/process plugins, **`tests/capabilities.rs`** ↔ **`PROD_COMMANDS`**); **§3.2** gap defers error-code exhaustiveness. MR **#250**. |
| 2026-05-08 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`429e71d`** (**#250**); **§3.8 CSP / WebView** **Partial** (**`tauri.conf.json`** CSP, **`tauri.mas.conf.json`** no override, **`index.html`** / **`hydrate-theme.js`**, **MAS-0b** §6 + **MAS-2c** cross-links; **§3.9** **`tauri.conf.json`** row). MR **#251** + MR review: **`app.security.csp`** path, **`blob:`**/**`data:`** gap vs **`img-src`**. |
| 2026-05-09 | **MAS-9a (partial):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 tip **`8cb1362`** (**#251**); **§0** bars **A**/**B** **Partial**; **§3.9** **Status**/**Evidence**/**Gap** + **`ipc/commands`** **§3.8**; **§5** lens-deferral note. MR **#252**. |
| 2026-05-10 | **MAS-9b:** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 head **`a56b189`** (**#252**), GitHub compare **`8aaab40...a56b189`**, refreshed **`git diff --shortstat`**, **§2.2** row **#252**; **§5** **MAS-9b** P0/P1 **bar A** sweep (open **`bug`** **#215** / **#200**, **#208** spot-check — none block **bar A**; **MAS-9c** still gates **Pass**). |
| 2026-05-11 | **MAS-9c (scaffold):** [`phase-5-mas-review.md`](../review/phase-5-mas-review.md) §2 head **`3573d1c`** (**#253**), compare **`8aaab40...3573d1c`**, **§2.2** row **#253**; **§5** operator **Canonical MAS smoke** evidence table + **§1** pointer; **CI** [`mas-package-verify.yml`](../../.github/workflows/mas-package-verify.yml) / [`mas-sandbox-launch-smoke.sh`](../../scripts/ci/mas-sandbox-launch-smoke.sh) called out as supplement for item **1** only. MR **#254**. |
